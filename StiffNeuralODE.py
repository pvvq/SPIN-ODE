...
# ── rate constants ────────────────────────────────────────────────────────────
k1  = .35e0;  k2  = .266e2; k3  = .123e5; k4  = .86e-3;  k5  = .82e-3
k6  = .15e5;  k7  = .13e-3; k8  = .24e5;  k9  = .165e5;  k10 = .9e4
k11 = .22e-1; k12 = .12e5;  k13 = .188e1; k14 = .163e5;  k15 = .48e7
k16 = .35e-3; k17 = .175e-1;k18 = .1e9;   k19 = .444e12; k20 = .124e4
k21 = .21e1;  k22 = .578e1; k23 = .474e-1;k24 = .178e4;  k25 = .312e1
...
_sol = diffrax.diffeqsolve(
    ODETerm(pollu),
    Kvaerno3(),
    t0=tspan[0], t1=tspan[1], dt0=1e-3,
    y0=u0,
...
for epoch in range(iter_, n_epoch + 1):
    ...
    if epoch % n_plot == 0:
        ...
        ax1.semilogy(list_loss);  ax1.set_xlabel("Epoch"); ax1.set_ylabel("Loss");          ax1.set_title("Loss")
        ax2.semilogy(list_grad);  ax2.set_xlabel("Epoch"); ax2.set_ylabel("Gradient Norm"); ax2.set_title("Grad Norm")
        fig.tight_layout()
